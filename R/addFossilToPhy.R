...
#' @param maxLength maximum length leading to the fossil. If NULL (default) then the maximum bound is half the length of the branch leading to the crown node
